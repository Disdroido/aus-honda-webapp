          ...
          <div class="mt-6 grid grid-cols-1 gap-3">
            <div>
              <button
                ...
                class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-transparent hover:border-aushondared hover:text-aushondared duration-300"
              >
